      ...
      <div class="row">
        ...
        <div class="col-sm-4 text-center" style="border:2px solid gray;padding:50px;">
          <?php
                      ...
                      if(empty($_POST['id1']) || empty($_POST['word']))
                      {
                        $error= "UserName or Password is Required.";
                      }
                      else
                      {
                        $admin_name= test_input($_POST['id1']);
                        $admin_password= test_input($_POST['word']);
                        ...
                        $sql= "SELECT * FROM passin.passout WHERE userid='".$admin_name."' AND password2='".$admin_password."'";
                        $qry=$dbcon->query($sql);
                        ...
                        else
                        {
                          ...
                          echo "<br><a href='userf.php' class='btn btn-primary'><span class='glyphicon glyphicon-refresh'></span> <strong>Try Again</strong></a>";
                        }
